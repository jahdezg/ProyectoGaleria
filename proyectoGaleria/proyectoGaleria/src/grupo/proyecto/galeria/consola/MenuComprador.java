...
public class MenuComprador {
    ...
    private static void comprarPiezas(Scanner scanner, String nombreComprador) {
    ...
    private static void definirMetodoPago(Scanner scanner, String nombreComprador) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(PIEZAS_COMPRADOR_FILE_PATH, true))) {
    ...
    private static void verPendientes(String nombreComprador) {
    ...
    private static boolean comprarPieza(String nombrePieza, String nombreComprador) {
        try (BufferedReader br = new BufferedReader(new FileReader(PIEZAS_FILE_PATH))) {
            String linea;
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length >= 7 && partes[0].equalsIgnoreCase(nombrePieza) && partes[5].equalsIgnoreCase("false")) {
                    ...
                    try (FileWriter fw = new FileWriter(PIEZAS_COMPRADOR_FILE_PATH, true)) {
