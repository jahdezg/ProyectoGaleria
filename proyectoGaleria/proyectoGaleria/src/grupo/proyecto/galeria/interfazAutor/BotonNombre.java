...
public class BotonNombre {
    private JFrame frame;
    private MenuRoles menuRoles;
    private JTextField autorField;
    private JList<String> piezasList;

    public BotonNombre(JFrame frame, MenuRoles menuRoles) {
        this.frame = frame;
    ...
    private void buscarPiezasPorAutor() {
        String autor = autorField.getText().trim().toLowerCase(); // Normaliza el nombre del autor
        if (autor.isEmpty()) {
